# from src.modules.core.entrypoints.asgi.middleware.auth_middleware import AuthMiddleware # noqa
from src.modules.core.entrypoints.asgi.middleware.config_middleware import ConfigMiddleware  # noqa
